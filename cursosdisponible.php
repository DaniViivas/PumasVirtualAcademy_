    ...
    <?php foreach ($lista_cursos as $curso): ?>
        <div class="row mb-4 align-items-center">
            ...
            <div class="col-md-8 d-flex flex-column">
                ...
                <button type="button" class="btn btn-primary mt-auto" onclick="registrarCurso(<?php echo htmlspecialchars($curso['id_curso']); ?>, <?php echo htmlspecialchars($id_usuario); ?>)">Registrar</button>
            </div>
        </div>
